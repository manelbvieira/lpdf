...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen relative flex flex-col">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col min-h-screen justify-center px-6">
        {/* Logo centered above credentials */}
        ...
        {/* Main content */}
        <div className="w-full max-w-sm bg-white/10 backdrop-blur-[25px] border border-white/20 rounded-xl p-8 mx-auto">
          <div className="mb-12">
